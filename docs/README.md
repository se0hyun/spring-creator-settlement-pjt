...
루트 [README.md](../README.md)에서 실행 방법과 API 요약을 볼 수 있습니다. 상세 내용은 아래 파일을 참고하세요.

| 파일 | 설명 |
|------|------|
| [requirements-and-assumptions.md](requirements-and-assumptions.md) | 요구사항 해석 및 가정 |
| [design-decisions.md](design-decisions.md) | 설계 결정과 이유 |
